...
?>
<option value="<?php echo $inner_cat_data->id; ?>" <?php echo ($select_option == $inner_cat_data->id)?"selected":""; ?>><?php echo stripslashes($inner_cat_data->name."  ".$inner_cat_data->amount); ?></option>
<?php 
}
