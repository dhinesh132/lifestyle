...
class frame_master extends database_manipulation
{
	...
	function frame_master()
	{

		$this->frm_name = "frame_master_frm";

		$this->cls_tbl = "frame_master";
	...
	function fetch_record($id, $frame_status_chk="-1")
	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::fetch_record() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::fetch_record() - Return Value : ', $res);
	...
	function fetch_pages($pl_id)
	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::fetch_pages() - PARAMETER LIST : ', $param_array);
			
		$condition = "pl_id = '" . $pl_id . "' and frame_status='1'";

		$res = database_manipulation::fetch_flds($this->cls_tbl, "frame_id,frame_name", $condition);
	
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::fetch_pages() - Return Value : ', $res);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::insert() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::insert() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::update() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::update() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::delete() - PARAMETER LIST : ', $param_array);
		if($rec_id > 0)
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD frame_master::delete() - Return Value : ', $ret_val);
		return $ret_val;
