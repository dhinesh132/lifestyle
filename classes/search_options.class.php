...
class search_options extends database_manipulation

{
...

	{
		...
		$this->frm_name = "search_options_frm";



		$this->cls_tbl = "search_options";
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::insert() - PARAMETER LIST : ', $param_array);
...

		{
			...
			frame_notices("Search option already exists !!", "redfont",1);
...

		{
...

			{
				...
				frame_notices("Search option not added due to the following reasons!!", "redfont",1);
			...
			{			
				...
				frame_notices("Search option successfully added !!", "greenfont", 1);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::insert() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::update() - PARAMETER LIST : ', $param_array);
...

		{
...

			{
				...
				frame_notices("Search option name already exists !!", "redfont", 1);
			...
			$resultset = database_manipulation::insert_record($this);
...

				{
					...
					frame_notices("Search option details not updated due to the following reasons!!", "redfont",1);
				...
				frame_notices("Search option details successfully updated !!", "greenfont", 1);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::update() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::delete() - PARAMETER LIST : ', $param_array);
...

		{
			...
			frame_notices("Search option deleted !!", "greenfont");

		}

		

		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::delete() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
...

	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::fetch_record() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD search_options::fetch_record() - Return Value : ', $res);
