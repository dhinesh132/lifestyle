...
class product_colours extends database_manipulation
{
	...
	function product_colours()
	{

		$this->frm_name = "product_colours_frm";

		$this->cls_tbl = "product_colours";

		$this->cls_sql = "select * from " . $this->cls_tbl . " where 1 = 1 ";

		$this->unique_flds = "Id";

		$this->file_flds = "Picture,SmallImage";
		...
		$this->SmallImage = array("frm_fldname" => "SmallImage", "fld_type" => "str", "frm_fld_type" => "img", "save_todb" => "false", "value" => "");
	...
	***********************************************************************************************/
	...
	function insert()
	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::insert() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::insert() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	function update($id,$where_notice="outside")
	{
		...
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::update() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::update() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	{
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::delete() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::delete() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	function fetch_record($id)
	{
		...
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::fetch_record() - PARAMETER LIST : ', $param_array);

		$condition = $this->primary_fld . " = '" . $id . "'";
		
		$res = database_manipulation::fetch_flds($this->cls_tbl, "*", $condition);
		
		$GLOBALS['logger_obj']->debug('<br>METHOD product_colours::fetch_record() - Return Value : ', $res);
