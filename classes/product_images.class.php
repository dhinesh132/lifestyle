...
class product_images extends database_manipulation
{
	...
	function product_images()
	{
		...
		$this->frm_name = "product_images_frm";

		$this->cls_tbl = "product_images";
	...
	***********************************************************************************************/
	...
	function insert()
	{
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::insert() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::insert() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	function update($id,$where_notice="outside")
	{
		...
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::update() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::update() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	{
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::delete() - PARAMETER LIST : ', $param_array);
		...
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::delete() - Return Value : ', $ret_val);
	...
	***********************************************************************************************/
	...
	function fetch_record($id)
	{
		...
		$param_array = func_get_args();
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::fetch_record() - PARAMETER LIST : ', $param_array);

		$condition = $this->primary_fld . " = '" . $id . "'";
		
		$res = database_manipulation::fetch_flds($this->cls_tbl, "*", $condition);
		
		$GLOBALS['logger_obj']->debug('<br>METHOD product_images::fetch_record() - Return Value : ', $res);
