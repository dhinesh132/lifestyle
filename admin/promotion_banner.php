...

{
	...
	case "preview":
...

		{
			...
			header("location:promotion_banner.php");
	...
	case "save":
		...
		{//need to add the record
			...
			if($ban_obj->insert())
				...
				$redirect_url = "promotion_banner.php";

			else

				$redirect_url = "promotion_banner.php?submit_action=add";
		...
		{//update the record
 			...
 			if($ban_obj->update($id))
				...
				$redirect_url = "promotion_banner.php?submit_action=edit&" . $ban_obj->primary_fld . "=" . $_REQUEST[$ban_obj->primary_fld];
...

{
	...
	case "detail_frm";
		...
		require_once("../forms/admin/promotion_banner_detail_frm.php"); 
	...
	case "list_frm";
		...
		require_once("../forms/admin/promotion_banner_list_frm.php"); 
