...
require_once("../classes/product_images.class.php");
require_once("../components/fckeditor/fckeditor.php"); 
$prod_obj = new product_images();
...
switch ($submit_action)
{
	...
	//$GLOBALS['site_config']['debug']=1;
		...
		{//need to add the record
			...
			if($prod_obj->insert())
				$redirect_url = "product_images.php";
			else
				$redirect_url = "product_images.php?submit_action=add";
		...
		{//update the record
				...
				else
				{
					...
					$redirect_url = "product_images.php?submit_action=edit&" . $prod_obj->primary_fld . "=" . $_REQUEST[$prod_obj->primary_fld];
				}
...
switch ($display_what)
{
	...
	case "detail_frm";
		require_once("../forms/admin/product_images_detail_frm.php"); 
		break;
	
	case "list_frm";
		require_once("../forms/admin/product_images_list_frm.php"); 
		break;
