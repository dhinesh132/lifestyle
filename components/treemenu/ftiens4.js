...
{ 
  ...
  {//03032007 - specific modifications
      SetCookie("clickedFolder", currentOpen+foldersTree.getID()+cookieCutter)
  }
}
...
var PRESERVESTATE = 0;
var ICONPATH = '<?php echo $GLOBALS['site_config']['site_path']; ?>components/treemenu/';
var HIGHLIGHT = 0;
var HIGHLIGHT_COLOR = '#b79a5f';//03032007 - menu modification
var HIGHLIGHT_BG    = '';//03032007 - menu modification
var BUILDALL = 0;
