<table width="100%" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr> 
            ...
            <td align="left" width="20%" valign="top"> <font class="postaddcontent">Billing&nbsp;Address:</font></td>
            ...
            <td nowrap width="20%" align="right" valign="top">Invoice Details :</td>
                                	...
                                	<table width="342px">
                                    	<tr>
                                            ...
                                            <?php echo SUBTOTAL." (".GSTINCL.")"?>:<br /><br />
                                             <?php if($master_data->tax_collected >0){?>
                                            GST (<?php echo $GLOBALS['site_config']['gst_percentage']?>%):<br /><br />
                                            <?php }?>
                                          ...
                                          <td width="35%" style="text-align:right; padding-right:18px"> 
                                            ...
                                            <?php if($master_data->tax_collected >0){?>
                                           	SGD <?php echo($master_data->ship_country !=189)?"-":"";echo format_number($master_data->tax_collected); ?><br />
                                            <?php }?> 
