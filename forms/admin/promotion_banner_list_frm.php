...
{ 
 ...
 if (doyou == true)
 {
 	  window.location.href="promotion_banner.php?" + url;
 }
}
...
<table width="90%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr > 
    <td align="right"><div align="right" class="pagination"><a href="promotion_banner.php?submit_action=add" class="pagelink">Add New</a> <a href="javascript:void(0)" onclick="delete_selected_item()" class="pagelink">Delete</a></div></td></tr></table>
...
<tbody>
  <tr class="maincontentheading" height=25px> 
    ...
    <th width="10%" class="listtitle">Expiry Date</th>
    <th width="30%" align="center" class="listtitle">Actions</th>
  </tr>
  <?php
  $preview_url = 0;
  $preview_url="../forms/admin/promotion_banner_preview_frm.php";
