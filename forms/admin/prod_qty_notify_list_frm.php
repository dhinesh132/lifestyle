...
<table width="85%" border="0" cellspacing="0" cellpadding="3" align="center" class="tableborder_new">
  <tr class="maincontentheading" height=25px> 
    <td width="7%" nowrap class="listtitle">Id# </td>
    <td width="25%" class="listtitle">Product Name</td>
    <td width="20%" class="listtitle">Product Code/Id</td>
    <td width="20%" class="listtitle">User</td>
    <td width="13%" class="listtitle">Email Status</td>
...
?>
  <tr <?php echo $row_bg_color; ?>  height=30px> 
    ...
    <td><?php  echo $GLOBALS['db_con_obj']->fetch_field("customer_master","concat(cust_firstname,' ', cust_lastname) as name","cust_id=".$data->UserId); ?></td>
    <td><?php  echo ($data->EmailStatus==0)?"Not Send":"Sent";; ?></td>
