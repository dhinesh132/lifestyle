...
{ 
 ...
 if (doyou == true)
 {
 	  window.location.href="product_sizes.php?" + url;
 }
}
...
.bktitle { font-weight: normal; }
 ...
 <table width="80%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr > 
    <td align="right"><div align="right" class="pagination"><a href="product_sizes.php?submit_action=add" class="pagelink">Add New </a> </div></td></tr></table>
 <br />
...
<table width="55%" border="0" cellspacing="0" cellpadding="3" align="center" class="listing">
  <tr class="maincontentheading" height=25px> 
    ...
    <th width="25%" class="listtitle">Pice($)</th>    
  ...
  <?php
  $preview_url = 0;
  $preview_url="../forms/admin/product_sizes_preview_frm.php";
  $list_url="product_sizes.php";
