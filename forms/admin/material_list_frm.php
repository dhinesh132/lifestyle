...
$qry = "select mat_id,mat_name from material_master where mat_status='1' order by mat_id asc";
...
if (in_array($data->mat_id, $material))
	$str = "checked";
else
	$str = "";
...
?>
  <td valign="bottom" width="166"> <table border="0" cellspacing="5" cellpadding="3" height="100%" class="productborder">
	...
	<tr><td><input type="checkbox" name="material[]" class="checkbox_cls" value="<?php echo $data->mat_id ?>" <?php echo $str;?>/>&nbsp;<?php echo stripslashes($data->mat_name);?>
    </td></tr>
