 ...
 if($edit == 1 && $edit_id > 0)
{
 ...
 ?>
<form action="order_export.php" method="post" enctype="multipart/form-data" name="export_frm" >
...
<fieldset class="tableborder_new"><legend class="maincontentheading">Filter Exports</legend>
        <table width="60%" border="0" align="center" cellpadding="5" cellspacing="0">
          ...
          <tr valign="top" class="postaddcontent"> 
           ...
           <tr valign="top" class="postaddcontent"> 
            <td width="30%"><span class="whitefont">Order Status:</span></td>
            <td width="70%">
            	<select name="order_status" >
                	<option value="" >All Orders</option>
                	<option value="0" >Payment Pending</option>
                	<option value="1">Paid, Shipment pending</option>
