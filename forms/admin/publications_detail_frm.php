...
<table width="70%" border="0" cellspacing="0" cellpadding="2" align="center" class="tableborder_new">
         ...
         <tr valign="top"> 
          ...
          <tr valign="top"> 
            <td  height="30" width="30%" class="postaddcontent"><span class="whitefont">Author </span><span class="starcolor">*</span></td>
            <td width="70%"><select name="AuthorId"   class="mediumtxtbox">
            <?php 
			...
			?>
			<option value="<?php echo $auth_data->AuthId; ?>" <?php if($auth_data->AuthId==$prod_obj->AuthorId['value']){?> selected="selected"<?php }?>><?php echo $auth_data->EnName; ?></option>
			<?php } ?>
            </select></td>
    	 </tr>
		 ...
		 <tr valign="top"> 
            ...
            <td><select name="ProdStatus" class="mediumtxtbox">
		...
		<tr valign="top"> 
            ...
            <tr valign="top"> 
                <td  height="30" width="20%" colspan="2" class="postaddcontent"><span class="whitefont">Description</span></td></tr>
                <tr>
                ...
                <?php
					...
					$fckChInfo = new FCKeditor('EnLongDesc') ;
					$fckChInfo->Value = stripslashes($prod_obj->EnLongDesc['value']);
					$fckChInfo->BasePath	= $sBasePath ;
					$fckChInfo->Create() ;
				?>
