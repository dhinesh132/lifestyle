...
<form name="cust_search_frm" method="post" action="" onSubmit="return check_orderform(window.document.cust_search_frm);">
  ...
  <table  align="center" cellpadding="5" cellspacing="0" width="100%" class="tableborder_new">
    <tr class="maincontentheading"> 
      <td align="center"><font class="buyerfont">Search Customers</font></td>
    </tr>
    <tr> 
      <td><table align="center" border="0" cellspacing="3" cellpadding="3">
	<!-- <tr valign="top"> 
            <td align="right"><span class="whitefont">Filter by :</span></td>
            <td><select name="filter_column">
                <option value="cust_firstname" <?php echo ($_SESSION['ses_cust_srch_vars']['filter_column'] == "customer_master.cust_firstname")?"selected":""; ?>>Customer First Name</option>
                <option value="customer_master.cust_lastname" <?php echo ($_SESSION['ses_cust_srch_vars']['filter_column'] == "customer_master.cust_lastname")?"selected":""; ?>>Customer Last Name</option>
              </select> <select name="filter_srch_typ">
                <option value="= '#val#'" <?php echo (stripslashes($_SESSION['ses_cust_srch_vars']['filter_srch_typ']) == "= '#val#'")?"selected":""; ?>>equals</option>
                <option value="like '%#val#%'" <?php echo (stripslashes($_SESSION['ses_cust_srch_vars']['filter_srch_typ']) == "like '%#val#%'")?"selected":""; ?>>contains</option>
              </select> <input type="text" name="filter_srch_val" value="<?php echo stripslashes($_SESSION['ses_cust_srch_vars']['filter_srch_val']); ?>"></td>
          </tr>-->
          <tr valign="top">
            <td align="right"><span class="whitefont">Keyword</span></td>
            <td><input type="text" name="cust_keyword" value="<?php echo stripslashes($_SESSION['ses_cust_srch_vars']['cust_keyword']);?>"/></td>
          </tr>
          <tr valign="top"> 
            <td width="149" align="right"><font class="whitefont">Status:</font></td>
            <td width="349"> <select name="cust_status">
			<option value="">Show All Status</option>
                <option value="customer_master.cust_status='0'" <?php echo (stripslashes($_SESSION['ses_cust_srch_vars']['cust_status']) == "customer_master.cust_status='0'")?"selected":""; ?>>In-Active</option>
				<option value="customer_master.cust_status='1'" <?php echo (stripslashes($_SESSION['ses_cust_srch_vars']['cust_status']) == "customer_master.cust_status='1'")?"selected":""; ?>>Active</option>
                
            </select></td>
          </tr>
       <!--   <tr valign="top"> 
            <td align="right"><span class="whitefont">Created&nbsp;Date:</span></td>
            <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr valign="top"> 
                  <td width="10"><span class="whitefont">from</span>&nbsp;</td>
                  <td> 
				  <?php
				  if (1==2)
				  {
	  ...
	  ?>
              ...
              <script language="JavaScript">
						var selcal = new calendar2(window.document.forms['cust_search_frm'].elements['repMonth'],window.document.forms['cust_search_frm'].elements['repDay'],window.document.forms['cust_search_frm'].elements['repYear']);
						selcal.year_scroll = true;
						selcal.time_comp = false;
						
						var selcal1 = new calendar2(window.document.forms['cust_search_frm'].elements['repMonth1'],window.document.forms['cust_search_frm'].elements['repDay1'],window.document.forms['cust_search_frm'].elements['repYear1']);
						...
						window.document.cust_search_frm.repMonth.value=tmmm;
						window.document.cust_search_frm.repMonth1.value=tmmm;
						...
						window.document.cust_search_frm.repDay.value=tmmm; 
						window.document.cust_search_frm.repDay1.value=tmmm; 
						*/
						window.document.cust_search_frm.repMonth.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repMonth']; ?>';
						window.document.cust_search_frm.repMonth1.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repMonth1']; ?>';
						window.document.cust_search_frm.repDay.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repDay']; ?>';; 
						window.document.cust_search_frm.repDay1.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repDay1']; ?>';
						window.document.cust_search_frm.repYear.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repYear']; ?>';; 
						window.document.cust_search_frm.repYear1.value ='<?php echo $_SESSION['ses_cust_srch_vars']['repYear1']; ?>';
						</script> </td>
          </tr>-->
          
          
          <tr valign="top">
            <td align="right"><span class="whitefont">Email</span></td>
            <td><input type="text" name="cust_email" value="<?php echo stripslashes($_SESSION['ses_cust_srch_vars']['cust_email']);?>"/></td>
          </tr>
          <tr valign="top"> 
            <td align="right"><span class="whitefont">Sort&nbsp;By:</font></td>
            <td><select name="sort_column">
                <option value='<?php echo "customer_master.cust_create_datetime asc"; ?>' <?php echo ($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_create_datetime asc")?"selected":""; ?>>Created Date Ascending</option>
				<option value='<?php echo "customer_master.cust_create_datetime desc"; ?>' <?php echo ($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_create_datetime desc")?"selected":""; ?>>Created Date Descending</option>
                <option value='<?php echo "customer_master.cust_firstname asc"; ?>' <?php echo ($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_firstname asc")?"selected":""; ?>>First Name Ascending</option>
				<option value='<?php echo "customer_master.cust_firstname desc"; ?>' <?php echo ($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_firstname desc")?"selected":""; ?>> First Name Descending</option>
                <option value='<?php echo "customer_master.cust_lastname asc";?>' <?php echo ($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_lastname asc")?"selected":""; ?>>Last Name Ascending</option>
				<option value='<?php echo "customer_master.cust_lastname desc";?>' <?php echo($_SESSION['ses_cust_srch_vars']['sort_column'] == "customer_master.cust_lastname desc")?"selected":""; ?>>Last Name Descending</option>
              </select> </td>
          </tr>
          <tr valign="top"> 
		  <td><a href="customer_search.php?submit_action=clear"> <img border="0" src="../images/clear.jpg"  name="clear" value="Clear"></a>
  ...
  if($_REQUEST['page'] =="home")
	{
		...
		if(!empty($_SESSION['ses_cust_srch_qry']))
	 	 ...
	 	 $qry1 = $_SESSION['ses_cust_srch_qry'];
		
  }
  else if(!empty($_SESSION['ses_cust_srch_qry']))
		 ...
		 $qry1 = "select concat(cust_firstname,'&nbsp;',cust_lastname) as cust_name, cust_id, cust_create_datetime, cust_status, cust_firstname, cust_lastname from  customer_master where 1 = 1  order by cust_create_datetime desc";
...
$preview_url="../forms/admin/customers_preview_frm.php";
 $list_url="customers.php";
  ...
  {
  ?><table align="center">
  <tr align="center" > <td class=""><font class='starfont'><strong><?php echo $paging_cls->num_of_rows." customer match search criteria"  ?></strong></font> </td></tr></table>
  <?php
  }
  ?>
  <table align="center" cellpadding="4" cellspacing="0" width="100%" class="tableborder_new">
    <tr class="maincontentheading"> 
      ...
      <td width="22%" align="center"><font class='buyerfont'>Date</font></td>
      <td width="17%"><font class='buyerfont'>Customer Name</font></td>
      <!--<td width="20%" align="center"><font class='buyerfont'>Amount($)</font></td>-->
      <td width="13%"><font class='buyerfont'>Status</font></td>
      <td width="13%">Purchase history</td>
      <td width="14%"><font class='buyerfont'>Action</font></td>
    </tr>
    <?php
    ...
    <tr <?php echo $row_bg_color; ?>  height=30px> 
      ...
      <td><a class='blue_link' href="#" onClick="popup_window('basedesign_nh.php?submit_action=preview&id=<?php echo stripslashes($data->cust_id); ?>&url=<?php echo $preview_url; ?>&list_url=<?php echo $list_url; ?>',600,500,'yes','yes')";>
        <?php
      ...
      <td> 
        <?php
	  echo $data->cust_create_datetime;
	  	  	?>      </td>
      <td> 
        <?php
	  echo $data->cust_name;
	 ...
	 <!-- <td align="center"> 
	  ...
	  echo "Active";
	  ?>      </td>
      <td nowrap><a href="purchase_history_frm.php?cust_id=<?=stripslashes($data->cust_id)?> " target="_blank" class="blue_link">history</a></td>
      <td nowrap><a href="customer_search.php?submit_action=edit&<?php echo $cust_obj->primary_fld; ?>=<?php echo stripslashes($data->cust_id); ?>"><img src="../images/icon_edit.gif" border=0 alt="Edit" align="absmiddle"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"><img src="../images/icon_delete.gif" border=0 onclick="delete_record('submit_action=delete&<?php echo $cust_obj->primary_fld;?>=<?php echo $data->cust_id; ?>')" alt="Delete" align="absmiddle"></a></td>
    </tr>
    <?php
		  }
		  }
...
?>
    <tr> 
      <td colspan="8" algin='center'> <font class='redfont'>No records found.</font></td>
    </tr>
    <?php
}
...
<?php 
if(1 == 2 && !empty($_SESSION['ses_cust_srch_qry']))
{
?>
...
var del_process = 0;
	...
	if(confirm('Are you sure to mark the selected orders as paid?\n(Ok=yes, Cancel=No)'))
		  { 
		  window.document.cust_search_frm.action='customer_search.php'; 
