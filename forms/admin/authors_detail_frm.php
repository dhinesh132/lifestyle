...
<table width="55%" border="0" cellspacing="0" cellpadding="2" align="center" class="tableborder_new">
         ...
         <tr valign="top"> 
            <td  height="30" width="23%" class="postaddcontent"><span class="whitefont">Chinese Title </span><span class="starcolor">*</span></td>
            <td width="77%"><input type="text" name="ChName" value="<?php echo stripslashes($mat_obj->ChName['value']); ?>" class="mediumtxtbox">   </td>
    	</tr>
          <tr valign="top"> 
            ...
            <td><select name="AuthStatus" class="mediumtxtbox">
			<option value="0" <?php echo ($mat_obj->AuthStatus['value'] == 0)?"selected":""; ?>>In-Active</option>
                <option value="1" <?php echo ($mat_obj->AuthStatus['value'] == 1)?"selected":""; ?>>Active</option>
          ...
          <tr valign="top" class="postaddcontent"> 
            <td colspan="2"><div align="center"> 
               ...
               <input type="hidden" name="CreatedDate" value="<?php echo (strlen($mat_obj->CreatedDate['value']) > 0)?$mat_obj->CreatedDate['value']:date("Y-m-d H:i:s"); ?>">
                <input type="hidden" name="AuthId" value="<?php echo $mat_obj->AuthId['value']; ?>">
              </div></td>
          </tr>
          <tr> 
