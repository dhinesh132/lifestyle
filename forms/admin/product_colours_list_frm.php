...
{ 
 ...
 if (doyou == true)
 {
 	  window.location.href="product_colours.php?" + url;
 }
}
...
.bktitle { font-weight: normal; }
 ...
 <table width="80%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr > 
    <td align="right"><div align="right" class="pagination"><a href="product_colours.php?submit_action=add" class="pagelink">Add New </a> </div></td></tr></table>
 <br />
...
<table width="55%" border="0" cellspacing="0" cellpadding="3" align="center" class="listing">
  ...
  <?php
  $preview_url = 0;
  $preview_url="../forms/admin/product_colours_preview_frm.php";
  $list_url="product_colours.php";
