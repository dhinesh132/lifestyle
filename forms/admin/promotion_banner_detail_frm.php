...
<table width="70%" border="0" cellspacing="0" cellpadding="2" align="center" class="listing">
           ...
           <tr valign="top" class="postaddcontent"> 
            <td height="31"><span class="whitefont">Big Banner Image</span><span class="starcolor">(800px X 350px & less then 1.5 MB)</span></td>
            <td><input type="file" name="BigBanImage" />
              <?php echo display_view_delete_links($ban_obj, "BigBanImage"); ?></td>
          </tr>
           <tr valign="top" class="postaddcontent"> 
           ...
           <tr valign="top" class="postaddcontent"> 
            <td height="30" ><span class="whitefont">Discount Value</span></td>
            <td ><select name="Type" class="mediumtxtbox" style="width:100px">
             ...
             &nbsp;<input type="text" name="Discount" value="<?php echo stripslashes($ban_obj->Discount['value']); ?>" class="mediumtxtbox" style="width:143px"></td>
          </tr>
         <!-- <tr valign="top" class="postaddcontent"> 
         ...
         <tr valign="top"> 
           ...
           <tr valign="top"> 
            <td  height="30" width="20%" class="postaddcontent"><span class="whitefont">Types</span><span class="starcolor">*</span></td>
            <td width="80%">
            <?php
            ...
            <select name="FunArray[]" class="mediumtxtbox" multiple="multiple" style="height:100px;" id="MenuId">
            <option value="">Please select</option>
			<?php $menu_res = $GLOBALS['db_con_obj']->fetch_flds("types",'EnName,TypeId','TypeStatus=1 order by EnName asc');
			while($menu_data = mysql_fetch_object($menu_res[0])){?>
            <option value="<?php echo $menu_data->TypeId;?>" <?php if(in_array($menu_data->TypeId,$menu_array)){?> selected="selected"<?php }?>><?php echo $menu_data->EnName;?></option>
            <?php } ?>
            </select> 
            </td>
    	 </tr>
...
$('#MenuId').change(function(){
  ...
  $fltrby = $('#Filterby').val();
  get_dynamic_dropdown('Items', 'admin_ajax_content.php', 'required=promotions&filterby='+$fltrby+'&menu='+str)
});
