...
<table width="75%" border="0" cellspacing="0" cellpadding="2" align="center" class="listing">
           ...
           <tr valign="top" class="postaddcontent"> 
            <td height="25" width="30%"><span class="whitefont">Colour </span><span class="starcolor">*</span></td>
          ...
          <tr valign="top" class="postaddcontent"> 
            <td height="25" width="30%"><span class="whitefont">Price</span><span class="starcolor">*</span></td>
           ...
           <tr valign="top" class="postaddcontent"> 
            <td height="25" width="30%"><span class="whitefont">Small Image</span> <span class="starcolor">&nbsp;(270px X 378px, Less then 1.5 MB )</span></td>
            <td width="70%"> <input type="file" name="SmallImage" value="<?php echo $prod_obj->SmallImage['value']; ?>" class="mediumtxtbox"> <?php echo display_view_delete_links($prod_obj, "SmallImage"); ?>
            </td>
          </tr>
          <tr valign="top" class="postaddcontent"> 
            <td height="25" width="30%"><span class="whitefont">Picture</span> <span class="starcolor">&nbsp;(1020px X 820px, Less then 1.5 MB )</span></td>
