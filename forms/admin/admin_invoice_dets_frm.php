<table width="100%" border="0" cellspacing="0" cellpadding="4">
        ...
        <tr><th width="100%" align="center" colspan="4"><h1 style="color: #807B5F;font-family: 'DINNextLTPro-Light'; font-size: 20px; font-weight: bold;line-height: 24px;">Tax Invoice </h1></th></tr> 
          <tr> 
            ...
            <td align="left" width="20%" valign="top"> <font class="postaddcontent"><img src="../invoice/eof.png" width="100px" /></font></td>

            <td width="35%" valign="top" align="left" style="text-align:left;"> <?php	
          ...
          <tr valign="top"> 
            ...
            <td width="20%" align="right">Company Address:</td>
        ...
        <tr>
                    	<td width="40%">
                        <p><img src="<?php echo $disp_img; ?>" alt="" width="76px" align="left" class="border" /><strong><?php echo display_field_value($prod_data,"Name");?><br />
				...
				echo "<div>Size: ".$siz_data->EnTitle." (".$siz_data->prod_code.")</div>"; 
				} ?>
                  ...
                  <table width="685px">
                        	<tr>
                                ...
                                <td width="50%" style="border-bottom:1px #D4CA9A solid;">
                                	...
                                	<table width="342px">
                                    	<tr>
                                       	  <td width="65%" style="text-align:right"> SUB TOTAL(GST incl.):<br /><br />
                                             <?php if($master_data->ship_country !=189){?>
                            ...
                            <tr>
                                ...
                                <td width="50%">
                                	...
                                	<table width="342px">
                                    	<tr>
                                       	  <td width="65%" style="text-align:right"> TOTAL COST:   <br />
                                           <?php if($master_data->ship_country ==189){?>
