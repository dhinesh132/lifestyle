...
<table <?php echo $inner_table_param; ?>>
  <tr>
	...
	<?php require_once("includes/error_message.php"); ?>
      <p class="login">Search Results</p>
...
{
$qry = "select * from ".$prod_obj->cls_tbl . " where ".$_REQUEST['srch_type']." like '%".$_REQUEST['search_value']."%' order by prod_id desc";
}
...
$paging_cls = new matrixpaging($qry,10,11,4);
...
?>
  <td valign="bottom" width="166"> <table border="0" cellspacing="5" cellpadding="3" height="100%" class="productborder">
		...
		if(file_exists($med_img_path) && is_file($med_img_path))
		  ...
		  ?><div align="center"><a href="<?php echo $detail_link; ?>"><img src="<?php echo $disp_img; ?>" border="0" alt="<?php echo stripslashes($data->prod_name); ?>"></a></div></td>
        </tr>
	...
	?></font><br>
    <font class="type">Author :</font>&nbsp;<font class="login"><?php echo $data->author;?></font><br>
