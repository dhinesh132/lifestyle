...
$res = $GLOBALS['db_con_obj']->fetch_flds($your_review_obj->cls_tbl, "*", "status=1 group by prod_id order by modify_datetime desc limit 0,10 ");
...
<tr>
  <td colspan="3" valign="top" class="content"><font class="heading">Latest Book Reviews</font></td>
  </tr>
  <tr><td>
<?php
if ($res[1] > 0)
...
{
//print_r($rev_data);
$rev_qry = "select prod_id, category_id, prod_name, prod_our_price,prod_normal_price, prod_th_image from ".$prod_obj->cls_tbl." where prod_id = '".$rev_data->prod_id."'";
...
echo stripslashes($rev_data->review_text);
?></font></td>
        </tr>
						 <tr>
